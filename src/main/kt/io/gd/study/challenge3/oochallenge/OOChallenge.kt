package io.gd.study.challenge3.oochallenge

fun main() {
    val bicycle = KotlinBicycle(10, 11, 7)
    bicycle.printDescription()

    val mountainBike = KotlinMountainBike(10, 10, 11, 7);
    mountainBike.seatHeight = 10
    mountainBike.printDescription()

    val roadBike = KotlinRoadBike(10, 10, 11, 7);
    roadBike.printDescription()


    val bicycle2 = KotlinBicycle(10, 11)
    bicycle2.printDescription()

    val mountainBike2 = KotlinMountainBike(10, 10, 11);
    mountainBike2.seatHeight = 10
    mountainBike2.printDescription()

    val roadBike2 = KotlinRoadBike(10, 10, 11);
...
open class KotlinBicycle constructor(var cadence: Int, var speed: Int, var gear: Int = 10) {
